      ...
      <div class="row"> 
       ...
       <div class="col-md-12"> 
        ...
        <ul class="menu-logo">
            ...
            <a href="admin/index.php"><img class="img-line"  src="images/logo.png" alt="logo" style="height: 56px"> </a>
...
<div class="row">
    ...
    <div class="alert alert-success" role="alert">
      ...
      <h4 class="alert-heading text-center"><img class="img-line"  src="images/logo.png" alt="logo" style="height: 56px"/></h4>

      <br>

        <div class="text-center">

          <h4 style="color: #94B91C;">CONGRATULATIONS!</h4>
      ...
      <hr>
        ...
        <div class="alert alert-success" role="alert">
         ...
         <p style="color: #004B7D;"><b>YOUR MESSAGE SENT SUCCESSFULLY WE WILL CONTACT YOU BACK!</b></p>
