                    ...
                    <div class="contact-box text-center">
                        ...
                        if (mysqli_num_rows($phone) > 0) {
...

                            {
                                ...
                                <a href="callto:1-877-Centive"><h5
                                            style="font-size: 16px;text-transform: lowercase;font-weight: 400;">
                                        1-877-Centive</h5></a><a href="callto:<?= $row4['data'] ?>">
                                <h5 style="font-size: 16px;text-transform: lowercase;font-weight: 400;"><?= $row4['data'] ?></h5>
                            </a>
                    ...
                    <div class="contact-box text-center">
                        ...
                        if (mysqli_num_rows($email) > 0) {
...

                            {
                                ...
                                <a href="mailto:<?= $row4['data'] ?>"><h5
                                            style="font-size: 16px;text-transform: lowercase;font-weight: 400;"><?= $row4['data'] ?></h5>
                                    <br></a>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                            ...
                            <form action="">
                                ...
                                <p style="text-align:center;">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary"
                                            name="AppoinmentForDealership">Appointment For Dealership
                                    </button>
                        ...
                        <div class="col-md-4">
                            <p style="text-align:center;">
                            <a href="quote.php" class="btn button red mx-auto">Request a
                                Consultation</a>
                            </p>
                        ...
                        <div class="col-md-4">
                            ...
                            <form action="">
                                ...
                                <p style="text-align:center;">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary"
                                            name="AppoinmentForConsultation">Appointment For Consultation
                                    </button>
                                ...
                                <div class="mt-3">
                                    ...
                                    <form class="mt-5" action="backend.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Your Firt Name"
                                                   name="name" required>
                                        ...
                                        <div class="form-group">
                                            <input placeholder="Date & Time" class="textbox-n form-control" type="text"
                                                   onfocus="(this.type='datetime-local')" id="date" name="dateTime"
                                                   required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                      name="reason" placeholder="Comment"></textarea>

                                        </div>

                                        <button type="submit" class="btn btn-primary" name="Dealership123">Submit
                                        </button>
                                        ...
                                        <form class="form-horizontal mt-5" role="form" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="selected-box">
                                                        ...
                                                        <select class="selectpicker" name="dealership" required>
                                                            ...
                                                            <option value="Dealership Purchase">Dealership Purchase
                                                            </option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input placeholder="Date & Time" class="textbox-n form-control"
                                                               type="text" onfocus="(this.type='datetime-local')"
                                                               id="date" name="time" required>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="number" class="form-control"
                                                               id="inlineFormInputGroup" placeholder="Monthly Budget"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="number" class="form-control"
                                                               ...
                                                               placeholder="Down Payment Amount" name="amount" required>
                                                    </div>
                                                </div>
                            ...
                            <form class="form-horizontal" role="form" method="post" action="email.php">
                                ...
                                <div class="contact-form row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button id="submit" name="send" type="submit" class="button red"> Send your
                                            message
                                        </button>
