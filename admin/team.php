                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                          ...
                          <td>
                           <div class="text-center align-self-center">
                              <?php echo $rec2['author']; ?> 
                           </div>
                        </td>
                        <td>
                           <div class="text-center align-self-center">
                              <img src="<?php echo "images/team/".$rec2['image_name']; ?>" alt="" style="height:100px;width:200px;">
                           </div>
                        </td>
                        <td>
                           <div class="text-center align-self-center">
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h3 class="modal-title">Edit Team Member Detail</h3>
                                 ...
                                 <form action="action.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                       <div class="col-md-10">
                                          <div class="row">
                                             <div class="col-md-10">
                                                <label style="margin-left: 30px; font-weight: bold;"> Name:</label>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   <input class="form-control" type="text" name="name" value="<?php echo $rec2['name']; ?>">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-md-10">
                                          <div class="row">
                                             <div class="col-md-10">
                                                <label style="margin-left: 30px; font-weight: bold;"> Position:</label>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                      <div class="row">
                                       <div class="col-md-12">
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   <input class="form-control" type="text" name="author" value="<?php echo $rec2['author']; ?>">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-4" style="margin-left: 9px;">  
                                          <button type="submit" class="btn btn-success btn-icon-split" name="edit_team">
                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 <form action="action.php" method="POST">
                                    <center><h3>Are You Sure to Delete This team Member?</h3></center>
                                    ...
                                    <br><br>
                                       ...
                                       <div class="modal-footer col-md-12" style="justify-content:center">
                                        <button type="submit" class="btn btn-success btn-icon-split" name="delete_team" style="background:red;border-color: red;color:white;">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body" style="padding-bottom:0px;">
            <form action="action.php" method="POST" enctype="multipart/form-data">
               ...
               <div class="row">
                  <div class="modal-footer col-md-12" style="justify-content:center">
                     <button type="submit" class="btn btn-success btn-icon-split" name="add_team">
                     <span class="text">Submit</span></button>
