    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger glyphicon glyphicon-remove'></button></div>`);
                ...
                if (file.type && file.type.search(/image/) != -1) {
                    fReader.onloadend = function(e) {
                        let image2 = $("<a data-lightbox='example-set' id='imagebox' ></a>");
                        image = $("<img  >");
                        image3 = $("</a>");
                        image.attr("src", e.target.result);
                        $("#imgid").attr("src", e.target.result);
                        image2.attr("href", e.target.result);
                        container.append(image, image2, '</a>');
