                ...
                <form action="action.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-10">
                        <div class="row">
                           <div class="col-md-1"></div>
                           <div class="col-md-10">
                              <textarea  style="margin-left: 3px;" rows="10" cols="100" name="description"></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-1"  style="margin-left: 3px;" >
                        <button type="submit" class="btn btn-success btn-icon-split" name="add_banner" style="margin-left: -45px;">
