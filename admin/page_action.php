							...
							<tr>
								...
								<td>
								    ...
								    foreach($product as $product2)
								        {
                                        ?> 
										<img src="<?php echo "images/banners/".$product2['image_name']; ?>" alt="" style="height:100px;width:200px;">
                                       	<?php  }?>
									</div>
								</td>
								<td>
									<a href="page_edit.php?id=<?php echo $rec2['id'];?>">
									...
									<a href="action.php?delete_banner=<?php echo $rec2['id'];?>">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<form action="action.php" method="POST" enctype="multipart/form-data">
					...
					<br><br>
					  <div class="row">
						...
						<button type="submit" class="btn btn-success btn-icon-split" name="add_banner">
